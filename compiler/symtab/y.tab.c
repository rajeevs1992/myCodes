...
{
      11,     0,    -1,    12,    13,     7,    13,     8,    11,    -1,
      -1,     6,    -1,    -1,    -1,     3,     4,    14,    15,    13,
      -1,    -1,     9,    -1,    -1
};
...
{
  "$end", "error", "$undefined", "KEYWORD", "VAR", "ELSE", "PRE", "'{'",
  "'}'", "';'", "$accept", "E", "P", "S", "$@1", "COL", 0
};
#endif
